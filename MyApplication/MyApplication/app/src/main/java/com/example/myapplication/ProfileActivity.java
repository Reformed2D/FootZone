...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnReclamation = findViewById(R.id.btn_reclamation);

        btnReclamation.setOnClickListener(v -> {
            Intent reclamationIntent = new Intent(ProfileActivity.this, ReclamationActivity.class);
